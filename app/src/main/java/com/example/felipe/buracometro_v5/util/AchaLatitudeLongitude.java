...
//Classe que realiza comunicacao de rede GPS (Internet) ou GSM, retornando informacoes de Geo-localizacao

public class AchaLatitudeLongitude extends Service implements LocationListener {
    ...
    public AchaLatitudeLongitude(Context context) {
    ...
    public Location getLocation() {
        try {
            ...
            Log.e("dados", "isNetworkEnabled: " + isNetworkEnabled + " isGPSEnabled: " + isGPSEnabled);
    ...
    public void stopUsingGPS()
    {
        if(locationManager != null)
        {
            locationManager.removeUpdates(AchaLatitudeLongitude.this);
        }
    }
